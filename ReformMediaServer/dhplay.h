...
//
// cut progress call back function. This function reports the progress of the cutting of the file
// parameters:	nPort		
//				iProgress	cutting progress  [0, 100]
//				dwUser		user data
//
typedef void (__stdcall *CutProgressFunc)(DWORD nPort, int iProgress, DWORD dwUser);
PLAYSDK_API BOOL	CALLMETHOD PLAY_CutFileSegment(LONG nPort, long lBeginTime, long lEndTime, CutProgressFunc pFunc, char *sOutFilePath, DWORD dwUser);
